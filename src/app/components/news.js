...
function Newimg(props) {
    ...
    return ((newsimage.file_name != null) ? <Image src={src} alt="A portrait of me" width="600" height="362" loading="lazy" unoptimized={process.env.NEXT_PUBLIC_IMAGE_URL.includes('mangalam.cms')} /> : <div>No Image</div>);
}
