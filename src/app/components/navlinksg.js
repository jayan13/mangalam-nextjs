...
export default function NavLinksg() {
  ...
  <div className="gray-menu">
    <ul>
      ...
      <li><Link href="/category/news-in-pics.html" className={`link ${pathname === '/category' ? 'active' : ''}`}>New in Pics</Link></li>
      <li><Link href="/category/videos.html" className={`link ${pathname === '/category' ? 'active' : ''}`}>Videos</Link></li>
      <li><Link href="/category/web-stories.html" className={`link ${pathname === '/category' ? 'active' : ''}`}>Web stories</Link></li>
      <li><Link href="/category/shorts.html" className={`link ${pathname === '/category' ? 'active' : ''}`}>Shorts</Link></li>
      <li><Link href="/category/prodcast.html" className={`link ${pathname === '/category' ? 'active' : ''}`}>Podcasts</Link></li>
