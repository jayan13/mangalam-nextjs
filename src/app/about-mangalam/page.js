...
export default function AboutMangalam() {
    return (
        <div className="about-mangalam-page" style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'Arial, Helvetica, sans-serif' }}>
            <h1 style={{ borderBottom: '2px solid #ed1c24', paddingBottom: '10px', marginBottom: '30px', color: '#333' }}>About Mangalam</h1>

            <section className="content-section" style={{ marginBottom: '40px' }}>
                <h2 style={{ fontSize: '1.5rem', color: '#ed1c24', marginBottom: '15px' }}>OWNERSHIP</h2>
            ...
            <section className="content-section" style={{ marginBottom: '40px' }}>
                <h2 style={{ fontSize: '1.5rem', color: '#ed1c24', marginBottom: '15px' }}>GROUP PROFILE</h2>
                <p style={{ fontSize: '1rem', lineHeight: '1.6', color: '#444', marginBottom: '15px' }}>
                    Established in April 1969 by <strong style={{ color: '#333' }}>Mr. M. C. Varghese</strong>, an extraordinary visionary with social commitment and dedication. The Mangalam Group initiated the project of publishing a weekly magazine that would quench the thirst of an average Malayalee reader. The success of Malayalam Weekly marked the dawn of an era in the publishing sector of Kerala, rewriting the publishing history in Asia (circulation of 1.5 million in 1984) and established a well-reputed household name Mangalam in India.
                </p>
                <p style={{ fontSize: '1rem', lineHeight: '1.6', color: '#444', marginBottom: '15px' }}>
            ...
            <section className="content-section" style={{ marginBottom: '40px' }}>
                <h2 style={{ fontSize: '1.5rem', color: '#ed1c24', marginBottom: '15px' }}>FOUNDER CHAIRMAN</h2>
                <p style={{ fontSize: '1rem', lineHeight: '1.6', color: '#444' }}>
                    The Mangalam Group was founded by late <strong style={{ color: '#333' }}>Mr. M.C Varghese</strong>, a prodigious person with divine vision of the future and keen sense of understanding, very compassionate and more concerned about his fellow beings.
                </p>
            </section>

            <section className="content-section" style={{ marginBottom: '40px' }}>
                <h2 style={{ fontSize: '1.5rem', color: '#ed1c24', marginBottom: '15px' }}>LOCATION</h2>
                <p style={{ fontSize: '1rem', lineHeight: '1.6', color: '#444', marginBottom: '15px' }}>
            ...
            <div style={{ marginTop: '40px', padding: '20px', background: '#f9f9f9', borderRadius: '8px' }}>
                <Link href="/" style={{ color: '#ed1c24', fontWeight: 'bold' }}>← Back to Home</Link>
            </div>
        </div>
    );
}
