    ...
    if (adId == 0) {
      return (
        <div className="advertisement no-margin">
          ...
          <div className="ad">
            <Link href="https://ksfe.com/" target="_blank"><Image src={`${process.env.NEXT_PUBLIC_IMAGE_URL}/uploads/ads/KSFE-Banner-300-x-250-news.jpg`} alt={'KSFE'} width={300} height={250} loading="lazy" /></Link>
          </div>
        </div>);
    }
    else if (adId == 1) {
