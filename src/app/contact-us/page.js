...
export default function ContactUs() {
    return (
        <div className="contact-us-page" style={{ padding: '40px 20px', maxWidth: '1200px', margin: '0 auto', fontFamily: 'Arial, Helvetica, sans-serif' }}>
            <h1 style={{ borderBottom: '2px solid black', paddingBottom: '10px', marginBottom: '30px', color: 'black' }}>Contact Us</h1>
            ...
            <div className="contact-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(450px, 1fr))', gap: '40px' }}>
                ...
                <div className="contact-info-column">
                    <section style={{ marginBottom: '30px' }}>
                        <h3 style={{ color: 'black', borderBottom: '1px solid #eee', paddingBottom: '5px' }}>Postal Address</h3>
                    ...
                    <section style={{ marginBottom: '30px' }}>
                        <h3 style={{ color: 'black', borderBottom: '1px solid #eee', paddingBottom: '5px' }}>Customer Support</h3>
                    ...
                    <section style={{ marginBottom: '30px' }}>
                        <h3 style={{ color: 'black', borderBottom: '1px solid #eee', paddingBottom: '5px' }}>Content Support</h3>
                        <p style={{ fontSize: '0.9rem', color: '#666', marginBottom: '10px' }}>
                            Monday to Saturday (Except Public Holidays)<br />
                            09:00 AM to 06:00 PM IST
                        </p>
                    ...
                    <section style={{ marginBottom: '30px' }}>
                        <h3 style={{ color: 'black', borderBottom: '1px solid #eee', paddingBottom: '5px' }}>Advertisements</h3>
                        <p style={{ fontSize: '0.9rem', color: '#666', marginBottom: '10px' }}>
                            09:00 AM to 06:00 PM IST
                        </p>
                        <p style={{ lineHeight: '1.6', color: '#444' }}>
